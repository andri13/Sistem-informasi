<div id="left">
      ...
      <li class="<?php if (uri_string() == 'tampil-gardu' || uri_string() == 'tambah-gardu' || uri_string() == 'tampil-trafo' ||  uri_string() == 'tampil-penyulang' ||  uri_string() == 'tampil-user' ) echo "active";?>">
         ...
         <ul>
            <li class="<?php if (uri_string() == 'tampil-gardu') echo "active";?>">
                <a href="<?=base_url('index.php/tampil-gardu')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Data Gardu
               </a>
            </li>
			 <li class="<?php if (uri_string() == 'index.php/tampil-trafo') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-trafo')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Data Trafo
               </a>
            </li>
          <li class="<?php if (uri_string() == 'index.php/tampil-penyulang') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-penyulang')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Data Penyulang
               </a>
            </li>
          <li class="<?php if (uri_string() == 'index.php/tampil-user') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-user')?>">
   ...
   <li class="<?php if (uri_string() == 'tambah-pengukuran' || uri_string() == 'tampil-pengukuran' ) echo "active";?>">
         ...
         <ul>
         <li class="<?php if (uri_string() == 'index.php/tambah-pengukuran') echo "active";?>">
                <a href="<?=base_url('index.php/tambah-pengukuran     ')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Tambah Pengukuran
               </a>
            </li>
            <li class="<?php if (uri_string() == 'index.php/tampil-pengukuran') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-pengukuran')?>">
