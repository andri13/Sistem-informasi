<div id="left">
   ...
   <ul id="menu" class="bg-blue blue">
      <li class="<?php if (uri_string() == 'index.php/Rayon/dashboardRayon') echo "active";?>">
          <a href="<?=base_url('index.php/Rayon/dashboardRayon')?>">
      ...
      <li class="<?php if (uri_string() == 'tampil-garduR' || uri_string() == 'tampil-trafoR' || uri_string() == 'tampil-penyulangR') echo "active";?>">
         ...
         <ul>
            <li class="<?php if (uri_string() == 'index.php/tampil-garduR') echo "active";?>">
                <a href="<?=base_url('index.php/tampil-garduR')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Data Gardu
               </a>
            </li>
            <li class="<?php if (uri_string() == 'index.php/tampil-trafoR') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-trafoR')?>">
