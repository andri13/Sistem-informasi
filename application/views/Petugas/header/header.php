<div id="left">
   ...
   <ul id="menu" class="bg-blue blue">
      <li class="<?php if (uri_string() == 'index.php/Petugas/dashboardPetugas') echo "active";?>">
          <a href="<?=base_url('index.php/Petugas/dashboardPetugas')?>">
   ...
   <li class="<?php if (uri_string() == 'tambah-ukurp' || uri_string() == 'tampil-ukurp' ) echo "active";?>">
         ...
         <ul>
         <li class="<?php if (uri_string() == 'index.php/tambah-ukurp') echo "active";?>">
                <a href="<?=base_url('index.php/tambah-ukurp')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Tambah Pengukuran
               </a>
            </li>
            <li class="<?php if (uri_string() == 'index.php/tampil-ukurp') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-ukurp')?>">
