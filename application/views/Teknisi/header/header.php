<div id="left">
   ...
   <ul id="menu" class="bg-blue blue">
      <li class="<?php if (uri_string() == 'Teknisi/dashboardTeknisi') echo "active";?>">
          <a href="<?=base_url('index.php/Teknisi/dashboardTeknisi')?>">
      ...
      <li class="<?php if (uri_string() == 'tampil-garduT' || uri_string() == 'tampil-trafoT' || uri_string() == 'tampil-penyulangT' || uri_string() == 'tampil-pengukuranT') echo "active";?>">
         ...
         <ul>
            <li class="<?php if (uri_string() == 'index.php/tampil-garduT') echo "active";?>">
                <a href="<?=base_url('index.php/tampil-garduT')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Data Gardu
               </a>
            </li>
			<li class="<?php if (uri_string() == 'index.php/tampil-trafoT') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-trafoT')?>">
               <i class="fa fa-angle-right"></i> &nbsp;Data Trafo
               </a>
            </li>
          <li class="<?php if (uri_string() == 'index.php/tampil-penyulangT') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-penyulangT')?>">
  ...
  <li class="<?php if (uri_string() == 'tampil-ukurT' || uri_string() == 'cetak-pengukuranT' ) echo "active";?>">
         ...
         <ul>
            <li class="<?php if (uri_string() == 'index.php/tampil-ukurT') echo "active";?>">
               <a href="<?=base_url('index.php/tampil-ukurT')?>">
